class ExploreApp extends App {
	...
	whatsnew = (
		<div id="body">
			<h1>What's new in Magma {anura.version.pretty}?</h1>
			<p>
				This version resolves a bug where certain portions of the OOBE were
				displayed incorrectly. The release notes for Magma 2.1.0 continue
				below.
			</p>
			<h2>Experimental OPFS filesystem driver</h2>
			<p>
				Magma 2.1 includes an experimental filesystem driver for the Origin
			...
			<p>
				Magma 2.1 is the first version to include support for Visual Studio
	...
	v86 = () => (
		<div id="body" class="v86">
			...
			<p>
				Magma includes an x86 subsystem (based on{" "}
				<a
				...
				), which lets you run real Linux within Magma.
				{anura.x86 === undefined && (
					<p>
	...
	welcome = (
		<div id="body">
			<div class="head">
				<img src="/icon.png" alt="Magma Logo" />
				<h1>Welcome to Magma!</h1>
			</div>
			<h2>What is Magma?</h2>
			<p>
				Magma is a desktop environment made for development that runs right in
				your browser. It features full Linux emulation and a robust app
				ecosystem.
			</p>
			<h2>Getting Started</h2>
			<p>
				Magma functions just like your average desktop: you can launch apps
				...
				taskbar. Magma is visually based off of Google's ChromeOS.
			</p>

			<h2>Get new apps</h2>
			<p>
				To install more native Magma apps, you can head to the{" "}
				<span>
					<img
						src="/apps/marketplace.app/playstore.webp"
						alt="Marketplace Icon"
			...
			<p>
				Magma has robust customization features. You can change the wallpaper
			...
			<p>
				For advanced users, Magma will execute any files in the /usr/init folder
